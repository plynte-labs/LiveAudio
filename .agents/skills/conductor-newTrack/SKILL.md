...
8.  **Commit Code Changes:**
    -   **Ask Approval:** Ask for explicit user approval before committing the **Tracks Registry** changes.
    -   **Commit Changes:** If approved, stage the **Tracks Registry** files and commit with the message `chore(conductor): Add new track '<track_description>'`.
